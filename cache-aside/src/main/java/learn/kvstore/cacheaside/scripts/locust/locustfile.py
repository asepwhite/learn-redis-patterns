...
class SearchProductUser(HttpUser):
    product_names = [
        "Blouse","Dress","Pants","Jeans","Shorts","Trousers","Sweater","Cardigan","T-shirt","Tank top","Blazer","Coat","Parka","Raincoat","Jumpsuit",
        "Romper","Leggings","Yoga pants","Lingerie","Swimsuit","Bikini","Sarong","Scarf","Hat","Gloves","Belt","Tie","Socks","Shoes","Boots"
    ]
